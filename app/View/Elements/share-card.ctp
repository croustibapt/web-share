<div ng-mouseenter="bounceMarker(share.share_id);" ng-mouseleave="cancelBounceMarker(share.share_id);" class="div-share-card card" share-id="{{ share.share_id }}" style="max-height: 260px; height: 260px;">
