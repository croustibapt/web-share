<div class="card">
    <div class="row">
        <div class="user-card-picture-div col-md-2 text-center">
            <img class="user-card-picture-img img-thumbnail img-circle" src="http://graph.facebook.com/v2.3/<?php echo $user['external_id']; ?>/picture?type=large&width=150&height=150" />
        </div>
